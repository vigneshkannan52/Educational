...
class CourseAnnouncementController extends PostsController {
	...
	public function create_item_permissions_check( $request ) {
		...
		if ( ! $this->permission->rest_check_announcement_permissions( 'create' ) ) {
			return new \WP_Error(
	...
	public function delete_item_permissions_check( $request ) {
		...
		if ( ! $this->permission->rest_check_announcement_permissions( 'delete', $id ) ) {
			return new \WP_Error(
	...
	public function update_item_permissions_check( $request ) {
		...
		if ( ! $this->permission->rest_check_announcement_permissions( 'update', $id ) ) {
			return new \WP_Error(
