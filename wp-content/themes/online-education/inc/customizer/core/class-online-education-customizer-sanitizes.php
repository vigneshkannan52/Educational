<?php
/**
 * Online Education customizer class for theme customize sanitizes.
 *
 * Class Online_Education_Customizer_FrameWork_Sanitizes
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
...
/**
 * Online Education customizer class for theme customize callbacks.
 *
 * Class Online_Education_Customizer_FrameWork_Sanitizes
 */
class Online_Education_Customizer_FrameWork_Sanitizes {
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = Online_Education_Fonts::get_google_font_subsets();
