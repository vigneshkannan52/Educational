...
class Online_Education_Customize_Base_Option {

	public function __construct() {

		// Register to customize panels, sections and controls.
		add_filter( 'online_education_customizer_options', array( $this, 'register_options' ), 10, 2 );
	...
	public function get_section_description( $args ) {
		...
		// Description.
		$content  = '<div class="online-education-section-description">';
...
return new Online_Education_Customize_Base_Option();
