...
( function ( $ ) {
	...
	// Header display type.
	wp.customize(
		'online-education_header_display_type',
		function ( value ) {
			value.bind(
				function ( layout ) {
	...
	wp.customize(
		'online-education_footer_copyright_alignment_setting',
		function ( value ) {
			value.bind(
				function ( alignment ) {
	...
	wp.customize(
		'online-education_main_footer_layout_display_type',
		function ( value ) {
			value.bind(
				function ( layout ) {
					var display_type = layout;
					...
					if ( display_type === 'type_two' ) {
						$( '#colophon' ).removeClass( 'online-education-footer--classic-bordered' ).addClass( 'online-education-footer--classic' );
					} else if ( display_type === 'type_three' ) {
						$( '#colophon' ).removeClass( 'online-education-footer--classic' ).addClass( 'online-education-footer--classic-bordered' );
					} else if ( display_type === 'type_one' ) {
						$( '#colophon' ).removeClass( 'online-education-footer--classic online-education-footer--classic-bordered' );
					}
				}
			);
		}
