...
(
	function ( $ ) {
		 ...
		 *
		 * @class Online_EducationCustomizer
		 */
		Online_EducationCustomizer = {
			 ...
			 */
			init : function () {
				Online_EducationCustomizer._initToggles();
			},
			...
			_initToggles : function () {
				...
				OnlineEducationControlTrigger.triggerHook( 'online-education-toggle-control', api );
		...
		$(
			function () {
				Online_EducationCustomizer.init();
			}
		);
