		...
		wp.customize.bind(
			...
			function () {
				...
				wp.customize.section.each(
					function ( section ) {
						if (
							'online-education_section' !== section.params.type ||
				...
				wp.customize.panel.each(
					function ( panel ) {
						if (
							'online-education_panel' !== panel.params.type ||
		...
		wp.customize.Panel = wp.customize.Panel.extend(
			{
				attachEvents         : function () {
					...
					if (
						'online-education_panel' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'online-education_panel' !== this.params.type ) {
		...
		wp.customize.Section = wp.customize.Section.extend(
			{
				attachEvents         : function () {
					...
					if (
						'online-education_section' !== this.params.type ||
				...
				isContextuallyActive : function () {
					...
					if ( 'online-education_section' !== this.params.type ) {
				...
				wp.customize.control.each(
					function ( ctrl, i ) {
						...
						if ( description.length ) {
							...
							li_wrapper.append( '<i class="online-education-control-tooltip dashicons dashicons-editor-help" title="' + tooltip + '"></i>' );
						}
					}
				);
			}
 ...
 *
 * Currently used for the Online Education Upseel section only.
 */
(
	function ( $, api ) {
		api.sectionConstructor[ 'online-education-upsell-section' ] = api.Section.extend(
			{
