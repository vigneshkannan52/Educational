 ...
 *
 * Class Online_Education_Radio_Image_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
 ...
 * Class Online_Education_Radio_Image_Control
 */
class Online_Education_Radio_Image_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-radio-image';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="image image-col-{{{ data.image_col }}}">
			...
			<label for="{{ data.id }}{{ key }}" {{{ data.labelStyle }}} class="online-education-radio-image">
