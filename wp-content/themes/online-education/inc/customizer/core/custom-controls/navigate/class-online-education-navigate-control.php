 ...
 *
 * Class Online_Education_Navigate_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
 ...
 * Class Online_Education_Navigate_Control
 */
class Online_Education_Navigate_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-navigate';
	...
	protected function content_template() {
		?>
		<div class="customize-control-content ole-navigate">
			<?php
			echo sprintf(
