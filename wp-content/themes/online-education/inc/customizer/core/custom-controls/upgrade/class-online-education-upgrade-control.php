...
/**
 * Class Online_Education_Customize_Heading_Control
 */
class Online_Education_Upgrade_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-upgrade';
