 ...
 *
 * Class Online_Education_Buttonset_Control
 */
class Online_Education_Buttonset_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-buttonset';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="buttonset">
			...
			<div class="buttonset-inner">
				...
				<label for="{{ data.id }}{{ key }}" class="online-education-buttonset">
					{{{ data.choices[ key ] }}}
				</label>
			</div>
			<# } #>
