<?php
/**
 * Online Education customizer base control class for theme customize options.
 *
 * Class Online_Education_Customize_Base_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
...
/**
 * Online Education customizer base control class.
 *
 * Class Online_Education_Customize_Base_Control
 */
class Online_Education_Customize_Base_Control {
...
return new Online_Education_Customize_Base_Control();
