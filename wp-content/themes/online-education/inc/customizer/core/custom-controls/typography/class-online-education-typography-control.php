 ...
 *
 * Class Online_Education_Typography_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
 ...
 * Class Online_Education_Typography_Control
 */
class Online_Education_Typography_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-typography';
	...
	public function enqueue() {
		...
		$google_font_subsets = Online_Education_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'online-education' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'online-education' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'online-education' );
		...
		wp_localize_script(
			...
			'OnlineEducationCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'online-education-customize-controls',
			'OnlineEducationCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = Online_Education_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = Online_Education_Fonts::get_system_fonts();
		$standard_fonts_array = array();
		$default_variants     = $this->format_variants_array(
			apply_filters(
				'online_education_default_variants',
				array(
					'regular',
					'italic',
				)
	...
	public function get_google_fonts() {
		...
		$google_fonts          = Online_Education_Fonts::get_google_fonts();
		$font_variants         = Online_Education_Fonts::get_font_variants();
		$foogle_fonts__subsets = Online_Education_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = Online_Education_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = Online_Education_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'online-education' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="online-education-font-size-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="online-education-font-size-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="online-education-font-size-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'online-education' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="online-education-line-height-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="online-education-line-height-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="online-education-line-height-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'online-education' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="online-education-letter-spacing-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="online-education-letter-spacing-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="online-education-letter-spacing-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'online-education' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'online-education' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'online-education' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'online-education' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'online-education' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'online-education' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'online-education' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'online-education' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'online-education' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'online-education' ); ?></span>
				<div class="online-education-field-content">
					<select {{{ data.inputAttrs }}} id="online-education-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'online-education' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'online-education' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'online-education' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'online-education' ); ?></option>
						<option value="initial"
