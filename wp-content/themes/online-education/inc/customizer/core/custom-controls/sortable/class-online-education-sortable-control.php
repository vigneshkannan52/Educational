 ...
 *
 * Class Online_Education_Sortable_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
 ...
 * Class Online_Education_Sortable_Control
 */
class Online_Education_Sortable_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type       = 'online-education-sortable';
	...
	protected function content_template() {
		...
		<ul class="unsortable">
			...
			<li {{{ data.inputAttrs }}} class='online-education-sortable-item' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# }else { #>
			<li {{{ data.inputAttrs }}} class='online-education-sortable-item invisible' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# } #>
