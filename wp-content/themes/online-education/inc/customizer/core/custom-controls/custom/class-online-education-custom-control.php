 ...
 *
 * Class Online_Education_Custom_Control
 *
 * @package    ThemeGrill
 * @since      3.0.0
 */
 ...
 * Class Online_Education_Custom_Control
 */
class Online_Education_Custom_Control extends Online_Education_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'online-education-custom';
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="online-education-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="online-education-custom-links">
